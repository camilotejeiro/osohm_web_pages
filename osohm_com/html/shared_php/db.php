<?php
/***********************************************************************
* Osohm Database Class
* Class including library methods to access, read and modify our 
* mySql database securely. 
***********************************************************************/
if(class_exists('OsohmDatabase') == FALSE)
{
	class OsohmDatabase 
	{
		/***************************************************************
...
$osohm_database = new OsohmDatabase;
?>
